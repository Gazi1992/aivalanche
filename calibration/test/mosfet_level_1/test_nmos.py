...
templates_mosfet_level_1_nmso_path = os.path.abspath('../../src/templates/mosfet_level_1/nmos/')

reference_data_file = os.path.join(templates_mosfet_level_1_nmso_path, 'reference_data.json')
parameters_file = os.path.join(templates_mosfet_level_1_nmso_path, 'parameters.csv')
testbenches_file = os.path.join(templates_mosfet_level_1_nmso_path, 'testbenches.json')
dut_file = os.path.join(templates_mosfet_level_1_nmso_path, 'dut.cir')
dut_name = 'dut'
results_dir = 'results'
