...
class my_projects(QWidget):
    ...
    def init_ui(self):
        ...
        header_widget = header(navigation_path = header_navigation, on_search_text_changed = self.on_search, style = self.style)
        ...
        self.new_project_dialog = modal_1(parent = self, title = 'New project', placeholder = 'Project name',
                                          ...
                                          on_confirm = self.on_new_project_confirm, on_cancel = self.on_new_project_cancel, style = self.style)
    ...
    def update_projects(self):
        ...
        new_project_button = icon_text_button(parent = self, icon_path = plus_icon_path, button_height = PROJECT_CARD_HEIGHT, button_width = PROJECT_CARD_WIDTH,
                                              ...
                                              on_click = self.on_new_project_press)
        new_project_button.setStyleSheet(self.style.new_project_button)
