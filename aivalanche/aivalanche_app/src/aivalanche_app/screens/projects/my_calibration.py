...
class my_calibration(QWidget):
    ...
    def init_ui(self):
        ...
        # Model button    
        self.model_button = icon_text_button(parent = self, text = 'Model', checkable = True, on_click = self.on_model_click, button_height = CALIBRATION_TAB_BUTTON_HEIGHT, button_width = CALIBRATION_TAB_BUTTON_WIDTH)
        buttons_layout.addWidget(self.model_button)
        buttons_layout.addStretch()

        # Parameters button    
        self.parameters_button = icon_text_button(parent = self, text = 'Parameters', checkable = True, on_click = self.on_parameters_click, button_height = CALIBRATION_TAB_BUTTON_HEIGHT, button_width = CALIBRATION_TAB_BUTTON_WIDTH)
        buttons_layout.addWidget(self.parameters_button)
        buttons_layout.addStretch()

        # Optimizer button    
        self.optimizer_button = icon_text_button(parent = self, text = 'Optimizer settings', checkable = True, on_click = self.on_optimizer_click, button_height = CALIBRATION_TAB_BUTTON_HEIGHT, button_width = CALIBRATION_TAB_BUTTON_WIDTH)
        buttons_layout.addWidget(self.optimizer_button)
        buttons_layout.addStretch()

        # Results button    
        self.results_button = icon_text_button(parent = self, text = 'Results', checkable = True, on_click = self.on_results_click, button_height = CALIBRATION_TAB_BUTTON_HEIGHT, button_width = CALIBRATION_TAB_BUTTON_WIDTH)
    ...
    def on_reference_data_click(self, checked):
        if checked:
            ...
            self.optimizer_button.setChecked(False)
    ...
    def on_optimizer_click(self, checked):
        if checked:
            ...
            self.optimizer_button.setChecked(True)
