...
warning_icon_path = Path.joinpath(images_path, 'warning.png')
...
refresh_icon_path = Path.joinpath(images_path, 'refresh_icon.png')
refresh_hovered_icon_path = Path.joinpath(images_path, 'refresh_hovered_icon.png')
refresh_pressed_icon_path = Path.joinpath(images_path, 'refresh_pressed_icon.png')
