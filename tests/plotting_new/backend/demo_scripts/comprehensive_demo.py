...
# 2. BAR CHART - Categorical Data (TEMPORARILY DISABLED)
# Commenting out bar chart to test with single plot first
...
print(f"[STATUS:info] Total plots created: 1")  # Changed from 2 to 1